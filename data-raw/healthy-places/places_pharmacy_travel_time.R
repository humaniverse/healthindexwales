...
write_csv(pharmacy_travel_time, "data-raw/healthy-places/raw-data/pharmacy_travel_time.csv")

pharmacy_travel_time <- read_csv("data-raw/healthy-places/raw-data/pharmacy_travel_time.csv")
...
places_pharmacy_travel_time_msoa <- pharmacy_travel_time |>
...
usethis::use_data(places_pharmacy_travel_time_msoa, overwrite = TRUE)
