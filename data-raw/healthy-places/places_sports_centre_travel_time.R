...
# Some sports centres are in Northern Ireland - remove them from the dataset
wales_sports_centres <-
  sports_centres$osm_points[gb_lad, ] |>
  select(osm_id)
...
wales_sports_centres_lad <-
  st_join(wales_sports_centres, wales_lad) |>
